...
class DefaultLOcationTracker @Inject constructor(
    ...
    override suspend fun getCurrentLocation(): Location? {
        ...
        val hasAccessCourceLocationPermission=ContextCompat.checkSelfPermission(
            application,
        ...
        if(!hasAccessCourceLocationPermission||!hasAccessFineLocationPermission||!isGpsEnabled){
            return  null
        }
